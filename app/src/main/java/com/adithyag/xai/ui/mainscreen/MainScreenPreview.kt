...
fun MainScreenPreview() {
    ...
    val messages = MutableStateFlow<List<Message>>(
        listOf(
            Message(
                ...
                images = listOf(
                    Image(
                        uri = Uri.parse("android.resource://com.adithyag.xai/" + R.drawable.ic_launcher_foreground),
    ...
    XAiTheme {
        MainScreen(
            ...
            currentUserInput = MutableStateFlow(""),
            onUserInput = {},
            inputSuggestions = MutableStateFlow(listOf("Hello", "Hi")),
            onPersonaSelected = {},
